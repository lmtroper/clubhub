...
ALTER TABLE `clubs` ADD `hold_applications` BOOLEAN;
...
ALTER TABLE `announcements` ADD `visibility` ENUM("public", "private");
...
("1", "Romána Bahadur", "test1@test.com"),
("2", "Shelton Vazquez", "test2@test.com"),
("3", "Francine Jacobs", "test3@test.com"),
("4", "Geoffrey Hinton", "test4@test.com"),
("5", "Yann LeCun", "test5@test.com"),
("6", "Yoshua Bengio", "test6@test.com"),
("7", "Tammy Novak", "test7@test.com"),
("8", "Linda Mccoy", "test8@test.com"),
("9", "s"test28@test.com"),
("29", "Victor Berger", "test29@test.com"),
("30", "Léa Guillaume", "test30@test.com"),
("31", "Mee Omar", "test31@test.com"),
("32", "Morgan Shaw", "test32@test.com"),
("33", "Joshua Roberts", "test33@test.com"),
("34", "Lily Jones", "test34@test.com"),
("35", "Dixie Neal", "test35@test.com"),
("36", "Whitney Oneal", "test36@test.com"),
("37", "Tod Nguyen", "test37@test.com"),
("38", "Isaias Hudson", "test38@test.com"),
("39", "Keri Burns", "test39@test.com"),
("40", "Mohammed Jordan", "test40@test.com"),
("41", "Tyrone Harvey", "test41@test.com"),
("42", "Kris Pena", "test42@test.com"),
("43", "Janie Conrad", "test43@test.com"),
("44", "Thomas Knight", "test44@test.com"),
("45", "Eunice Nicholson", "test45@test.com"),
("46", "Robyn Stephens", "test46@test.com"),
("47", "Lana Gallagher", "test47@test.com"),
("48", "Nichole Michael", "test48@test.com"),
("49", "Pearl Perez", "test49@test.com"),
("50", "Katharine Aguilar", "test50@test.com");


-- Populate clubs table with clubs from WUSA
INSERT INTO `clubs` (name, categories, description) VALUES 
("A Cappella Club","creative-arts-dance-and-music","The UW A Cappella Club is the umbrella club of all a cappella groups at the University of Waterloo! UWACC was founded in 2008 originally with one ensemble and has since expanded to include many different groups including the AcaBellas, the Unaccompanied Minors, ACE, the Musical InterDudes, the Water Boys, and In Full Colour. 
...
-- -- Set the delimiter to handle the semicolon within the script
-- DELIMITER //

-- -- Create the stored procedure to populate memberships
-- CREATE PROCEDURE PopulateMemberships()
-- BEGIN
...
--         -- Loop to assign about 25 users to each club
--         WHILE j <= 25 DO
--             -- Generate a random user index from 1 to the total number of users
--             SET @randomUserId := (SELECT uid FROM users ORDER BY RAND() LIMIT 1);

--             -- Insert a membership record
--             INSERT INTO memberships (uid, club_id, role, title)
--             SELECT DISTINCT uid, i, 'user', null
--             FROM users
--             WHERE uid = @randomUserId;
